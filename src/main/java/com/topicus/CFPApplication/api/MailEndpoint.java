...
public class MailEndpoint {
	...
	/*
	 * gives information on all the mail configuration values. Will give current mail server,port,username and email.
	 * 
	...
	public Iterable<Applicant> sendMail(@PathVariable(name = "id")long id, @PathVariable(name ="templateName")String templateName) {
