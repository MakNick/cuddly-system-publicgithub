...
public class ApplicantEndpoint {
	...
	/* LIJKT OVERBODIG DOORDAT EEN APPLICANT ALLEEN IN COMBINATIE MET EEN PRESENTATIONDRAFT WORDT GEPOST. DIE METHODE STAAT IN PRESENTATIONDRAFTEND
	@POST
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public Response save(Applicant applicant) {
